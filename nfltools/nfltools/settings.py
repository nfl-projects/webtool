"""
Django settings for nfltools project.
...
SECRET_KEY = 'bwaxkhp0ti7ddq$8!u$-t4q3wc-czztmlp+x%o3wci2x1@s^lj'
...
WSGI_APPLICATION = 'nfltools.wsgi.application'
